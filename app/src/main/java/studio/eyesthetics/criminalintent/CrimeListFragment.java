...
public class CrimeListFragment extends ListFragment {
    ...
    private class CrimeAdapter extends ArrayAdapter<Crime> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            String dateTime = DateFormat.getDateTimeInstance(DateFormat.FULL, DateFormat.SHORT).format(c.getmDate());
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if(mSubtitleVisible && showSubtitle != null) {
            showSubtitle.setTitle(R.string.hide_subtittle);
        }
    }
        ...
        switch(item.getItemId()) {
            ...
            case R.id.menu_item_show_subtitle:
                if(getActivity().getActionBar().getSubtitle() == null) {
                    ...
                    item.setTitle(R.string.hide_subtittle);
                } else {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Button addNewCrime = (Button) emptyView.findViewById(R.id.add_new_crime);
